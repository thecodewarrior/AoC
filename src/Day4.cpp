...
void Day4::run_day() {
    ...
    print_trivia("Possible passwords", possible_passwords.size());
    print_result("Part one", "Password count", (int)part_one_passwords.size(), 1790);
    print_result("Part two", "Password count", (int)part_two_passwords.size(), 1206);
}
